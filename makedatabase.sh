...
echo 'makeblastdb -in $NUC_ALL_FASTA -input_type "fasta" -title "ICTV $VMR_FILE ($EA) genomic" -out "$BLAST_NUC_DB" -dbtype "nucl"'
makeblastdb -in $NUC_ALL_FASTA -input_type "fasta" -title "ICTV $VMR_FILE ($EA) genomic" -out "$BLAST_NUC_DB" -dbtype "nucl"
echo 'makeblastdb -in $PROT_ALL_FASTA -input_type "fasta" -title "ICTV $VMR_FILE ($EA) protein" -out "$BLAST_PROT_DB" -dbtype "prot"'
makeblastdb -in $PROT_ALL_FASTA -input_type "fasta" -title "ICTV $VMR_FILE ($EA) protein" -out "$BLAST_PROT_DB" -dbtype "prot"
